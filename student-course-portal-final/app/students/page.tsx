...
import StudentsPageGate from "@/components/StudentsPageGate";

export const metadata: Metadata = { title: "Students | StudentHub", description: "Manage students and their course enrollments (admin only)." };
