...
/**
 * Admin-only roster management: the full student list, with add/edit/delete
 * for any student and the ability to enroll/unenroll any of them in any
 * course. A logged-in student manages their own profile and enrollments
 * from /dashboard instead — this component isn't rendered for them at all
 * (see app/students/page.tsx), and the backend enforces the same boundary
 * independently via `authorize("admin")` on these endpoints.
 */
