...
export default function Navbar() {
  ...
  // Admins manage the full student roster; everyone else who's logged in
  // gets their own dashboard instead — the two roles see different links,
  // not just different buttons on the same page.
  ...
  const links = roleLink ? [...baseLinks.slice(0, 2), roleLink, ...baseLinks.slice(2)] : baseLinks;
